...
export default function CompanyInformationModal(props: Props) {
  ...
  return (
    ...
    >
      <div className="w-[calc(80vw)] h-[calc(90vh)] bg-white text-black z-10 flex relative">
        <div className="w-[20%] h-full bg-[#191414] text-[#ffffff] px-6 py-20">
          ...
          <div className="px-3 mt-20 flex flex-col gap-5">
            <div
        ...
        {activeScreen === 1 && (
          <div className="w-[80%] px-8 py-8 relative">
            ...
            <div className="w-full mt-5">
              ...
              <div className="w-full flex justify-between px-8 mb-10 absolute bottom-0 right-0">
                <button className="border-[#1ED760] border text-black text-base font-semibold px-8 py-2 rounded-3xl">
                  Back
                </button>
        ...
        {activeScreen === 2 && (
          <div className="w-[80%] px-8 py-8 relative">
            ...
            <div className="w-full mt-10">
              <div className="w-[100%] my-5">
                <p className="text-black font-medium mb-1">
                  You can modify your DoorLoop URL to match your company brand.
                </p>
                <input
                  type="text"
                  placeholder="Enter company name"
        ...
        {activeScreen === 3 && (
          <div className="w-[80%] px-8 py-8 relative">
            ...
            <div className="w-full mt-10">
              <div className="w-[100%] my-5">
                <p className="text-black font-medium mb-1">
                  The user selected below is the owner of this DoorLoop account.
                  They will always have full access to all the data and features
                  on this account.
                </p>
                <input
                  type="text"
