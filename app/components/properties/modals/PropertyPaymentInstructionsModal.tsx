...
export default function PropertyPaymentInstructionsModal({ onClose }: Props) {
  // ******* States *******
        ...
        <div className="w-[100%]  relative h-full">
          <div className="text-black w-full px-10 pt-10 h-full overflow-auto ">
            <div className="flex justify-between ">
              <div>
                <h1 className="text-[32px] font-bold">Payment Instructions</h1>
            ...
            <div className="flex gap-5 items-center mt-5">
              <p className="text-[#656D76]">
                You can set different payment instructions for each property as
            ...
            <div>
              <div className="flex gap-3 items-center mt-10">
                ...
                <p className="text-[#101928]">
                  Use company default payment instructions
                </p>
              </div>
              <div className="flex gap-3 items-center mt-5">
                ...
                <p className="text-[#101928]">
                  Specify payment Instructions for this property
                </p>
              </div>
            </div>
